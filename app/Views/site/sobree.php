            ...
            <div class="col-lg-12">
                <div class="breatcam-content text-center">
                    ...
                    <div class="breatcam-menu">
                        <ul>
                            <li><a href="<?php echo base_url('inocio')?>"> Inicio </a></li>
                            <li> Sobre nós </li>
                        </ul>
                    </div>
                </div>
...
Entre em contato conosco para descobrir como podemos fazer a diferença para você e sua empresa.<br>
                    </p>
                </div>
                <!-- lawyer button -->
                <div class="lawyer-button">
                    <a href="<?php echo base_url('contactos?id=#consul')?>"> Entre em contacto <i class="bi bi-arrow-right"></i> </a>
                </div>
            </div>
        </div>
    </div>
...
<!--==================================================-->
<div class="service-section style-two upper upp">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="lawyer-service-single-box">
                    <!-- service icon -->
                    <div class="service-icon">
                        <img src="assets/images/resource/icon1.png" alt="">
                    </div>
                    <!-- donate content -->
                    <div class="lawyer-service-content">
                            <!-- service title -->
