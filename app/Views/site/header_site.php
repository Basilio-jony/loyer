...
<head>
	...
	<!-- font-awesome CSS -->
	<link rel="stylesheet" href="<?php echo base_url('assets/css/all.min.css')?>" type="text/css" media="all" />
	<!-- font-flaticon CSS -->
	...
	<!-- bootstrap icons -->
	<link rel="stylesheet" href="<?php echo base_url('https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css')?>">
	
	<!-- menu scrip -->
	<link rel="stylesheet" href="<?php echo base_url('assets/css/menu.css')?>" type="text/css" media="all" />
	<script defer src="<?php echo base_url('assets/js/menu.js'); ?>"></script>
</head>
